...
#
# Usage:
#   bash scripts/server/stage3/run_stage3_pipeline.sh <dataset_root> <stage1_render_records_jsonl> <ipc>
#
# Examples:
#   # ImageNette, IPC=10
#   bash scripts/server/stage3/run_stage3_pipeline.sh \
...
if [[ $# -lt 3 ]]; then
  echo "Usage: bash scripts/server/stage3/run_stage3_pipeline.sh <dataset_root> <stage1_render_records_jsonl> <ipc>"
  exit 1
fi
