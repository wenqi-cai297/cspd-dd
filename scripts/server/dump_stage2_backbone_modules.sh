...
# Usage:
#   bash scripts/server/dump_stage2_backbone_modules.sh [backbone_name] [component] [extra args...]
# Example:
#   bash scripts/server/dump_stage2_backbone_modules.sh black-forest-labs/FLUX.1-Kontext-dev transformer --local-files-only
...
echo "[INFO] top-level:          $OUTPUT_DIR/pipeline_named_children.txt"
