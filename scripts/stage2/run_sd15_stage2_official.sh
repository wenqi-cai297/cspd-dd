...
# Usage:
#   bash scripts/stage2/run_sd15_stage2_official.sh <dataset_root> <stage1_render_records_jsonl> [batch_size] [epochs] [extra args...]
#
# Environment:
...
if [[ $# -lt 2 ]]; then
  echo "Usage: bash scripts/stage2/run_sd15_stage2_official.sh <dataset_root> <stage1_render_records_jsonl> [batch_size] [epochs] [extra args...]"
  exit 1
fi
