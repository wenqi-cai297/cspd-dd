...
# Usage:
#   bash scripts/stage2/run_stage2_train.sh <dataset_root> <stage1_render_records_jsonl> [backbone_name] [batch_size] [epochs] [extra args...]
# Example:
#   bash scripts/stage2/run_stage2_train.sh /data/imagenette/train runs/stage1/render/imagenette/qwen_local/2026-04-02_010203/records.jsonl
#
# Output directory:
...
if [[ $# -lt 2 ]]; then
  echo "Usage: bash scripts/stage2/run_stage2_train.sh <dataset_root> <stage1_render_records_jsonl> [backbone_name] [batch_size] [epochs] [extra args...]"
  exit 1
fi
