...
# Usage:
#   bash scripts/stage1/run_stage1_normalization.sh <attribute_run_dir_or_attributes_jsonl> [review_backend]
#   bash scripts/stage1/run_stage1_normalization.sh <attribute_run_dir_or_attributes_jsonl> --disable-vlm-review
# Example:
#   bash scripts/stage1/run_stage1_normalization.sh runs/stage1/attributes/ImageNette/qwen_local/2026-03-26_183111
#   bash scripts/stage1/run_stage1_normalization.sh runs/stage1/attributes/ImageNette/qwen_local/2026-03-26_183111/attributes.jsonl qwen_local
#   bash scripts/stage1/run_stage1_normalization.sh runs/stage1/attributes/ImageNette/qwen_local/2026-03-26_183111 --disable-vlm-review
#
# The output directory is generated automatically as:
#   <attribute_run_dir>/normalization/<timestamp>

if [[ $# -lt 1 ]]; then
  echo "Usage: bash scripts/stage1/run_stage1_normalization.sh <attribute_run_dir_or_attributes_jsonl> [review_backend]"
  echo "   or: bash scripts/stage1/run_stage1_normalization.sh <attribute_run_dir_or_attributes_jsonl> --disable-vlm-review"
  exit 1
fi
