...
#   bash scripts/stage1/run_stage1_pipeline.sh /media/4T_HDD/cai/datasets/ImageNette/train qwen_local
#
#   # ImageNet-1k 5-shot
#   bash scripts/stage1/run_stage1_pipeline.sh /media/4T_HDD/cai/datasets/ImageNet1k_5shot/train qwen_local
#
#   # Quick plumbing test with mock backend
#   bash scripts/stage1/run_stage1_pipeline.sh /media/4T_HDD/cai/datasets/ImageNette/train mock
#
# Environment:
...
if [[ $# -lt 1 ]]; then
  echo "Usage: bash scripts/stage1/run_stage1_pipeline.sh <dataset_root> [backend]"
  exit 1
fi
