...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--resolution", type=int, default=1024, help="Output image resolution")
    parser.add_argument("--num-inference-steps", type=int, default=50, help="Diffusion sampling steps")
    parser.add_argument("--guidance-scale", type=float, default=9.0, help="Classifier-free guidance scale")
