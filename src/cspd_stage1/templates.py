...
TEMPLATE_SPECS: dict[str, TemplateSpec] = {
    ...
    "food_and_drink": TemplateSpec(
        ...
        pre_anchor_slots=("color",),
        post_anchor_slots=("shape_or_structure", "preparation_or_serving_style", "container_or_context", "viewpoint", "salient_topping_or_ingredient"),
        slot_prefixes={"shape_or_structure": "with", "preparation_or_serving_style": "served", "container_or_context": "in", "viewpoint": "from", "salient_topping_or_ingredient": "with"},
    ...
    "container": TemplateSpec(
        ...
        pre_anchor_slots=("color", "material"),
        post_anchor_slots=("shape_or_structure", "fill_state_or_contents_visibility"),
        slot_prefixes={"shape_or_structure": "with", "fill_state_or_contents_visibility": ""},
    ...
    "natural_scene_or_landform": TemplateSpec(
        ...
        pre_anchor_slots=("terrain_or_surface_trait",),
    ...
    "human_or_person": TemplateSpec(
        ...
        pre_anchor_slots=("clothing_or_gear",),
        post_anchor_slots=("body_pose_or_action", "background_or_activity_context", "held_object_or_equipment"),
        slot_prefixes={"body_pose_or_action": "", "background_or_activity_context": "in", "held_object_or_equipment": "with"},
...
def get_template_spec(archetype: str) -> TemplateSpec:
    try:
        ...
        raise KeyError(f"Unsupported Stage 1 render archetype: {archetype}") from exc
