...
TEMPLATE_SPECS: dict[str, TemplateSpec] = {
    ...
    "food_and_drink": TemplateSpec(
        ...
        post_anchor_slots=("shape_or_structure", "preparation_or_serving_style", "salient_topping_or_ingredient"),
        slot_prefixes={"shape_or_structure": "with", "preparation_or_serving_style": "served", "salient_topping_or_ingredient": "with"},
    ...
    "natural_scene_or_landform": TemplateSpec(
        ...
        post_anchor_slots=("weather_or_water_state", "salient_geographic_feature"),
        slot_prefixes={"weather_or_water_state": "with", "salient_geographic_feature": "with"},
